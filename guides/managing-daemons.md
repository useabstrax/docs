...
This guide runs a long-lived process under Supervisor, then checks its status and logs. Use daemons for processes that should run continuously, such as queue workers or websocket servers. For scheduled tasks, use [cron](managing-cron-jobs.md) instead.
...
- [Daemons command reference](../commands/daemons.md)
- [Managing cron jobs](managing-cron-jobs.md)
- [Services](../commands/system.md#service-commands)

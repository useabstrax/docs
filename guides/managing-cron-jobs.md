...
Cron jobs run on a schedule and then exit. For a process that should run continuously (such as a queue worker), use a [daemon](managing-daemons.md) instead.

## Related

- [Cron command reference](../commands/cron.md)
- [Managing daemons](managing-daemons.md)

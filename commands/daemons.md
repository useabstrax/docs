...
Use daemons for processes that should run continuously (queue workers, websocket servers, and similar). For scheduled tasks that run and exit, use [cron](cron.md) instead.
...
- [Managing daemons](../guides/managing-daemons.md)
- [Cron](cron.md) – for scheduled jobs
- [Services](system.md#service-commands) – for systemd services
